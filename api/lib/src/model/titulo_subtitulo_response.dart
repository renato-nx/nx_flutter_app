...
part 'titulo_subtitulo_response.g.dart';

/// TituloSubtituloResponse
///
/// Properties:
/// * [id] 
/// * [linguagem] 
...
abstract class TituloSubtituloResponse implements Built<TituloSubtituloResponse, TituloSubtituloResponseBuilder> {
    ...
    TituloSubtituloResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(TituloSubtituloResponseBuilder b) => b;

    factory TituloSubtituloResponse([void updates(TituloSubtituloResponseBuilder b)]) = _$TituloSubtituloResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<TituloSubtituloResponse> get serializer => _$TituloSubtituloResponseSerializer();
}

class _$TituloSubtituloResponseSerializer implements StructuredSerializer<TituloSubtituloResponse> {
    @override
    final Iterable<Type> types = const [TituloSubtituloResponse, _$TituloSubtituloResponse];

    @override
    final String wireName = r'TituloSubtituloResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, TituloSubtituloResponse object,
    ...
    @override
    TituloSubtituloResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TituloSubtituloResponseBuilder();
