...
part 'solicitante_response.g.dart';
...
/// * [ativo] 
/// * [cliente] 
abstract class SolicitanteResponse implements Built<SolicitanteResponse, SolicitanteResponseBuilder> {
    ...
    SolicitanteResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(SolicitanteResponseBuilder b) => b;

    factory SolicitanteResponse([void updates(SolicitanteResponseBuilder b)]) = _$SolicitanteResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<SolicitanteResponse> get serializer => _$SolicitanteResponseSerializer();
}

class _$SolicitanteResponseSerializer implements StructuredSerializer<SolicitanteResponse> {
    @override
    final Iterable<Type> types = const [SolicitanteResponse, _$SolicitanteResponse];

    @override
    final String wireName = r'SolicitanteResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, SolicitanteResponse object,
    ...
    @override
    SolicitanteResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = SolicitanteResponseBuilder();
