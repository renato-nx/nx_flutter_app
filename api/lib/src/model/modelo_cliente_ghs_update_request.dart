...
part 'modelo_cliente_ghs_update_request.g.dart';

/// ModeloClienteGHSUpdateRequest
///
/// Properties:
/// * [id] 
/// * [descricao] 
...
/// * [pictogramasCreate] 
/// * [pictogramas] 
abstract class ModeloClienteGHSUpdateRequest implements Built<ModeloClienteGHSUpdateRequest, ModeloClienteGHSUpdateRequestBuilder> {
    ...
    ModeloClienteGHSUpdateRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(ModeloClienteGHSUpdateRequestBuilder b) => b;

    factory ModeloClienteGHSUpdateRequest([void updates(ModeloClienteGHSUpdateRequestBuilder b)]) = _$ModeloClienteGHSUpdateRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<ModeloClienteGHSUpdateRequest> get serializer => _$ModeloClienteGHSUpdateRequestSerializer();
}

class _$ModeloClienteGHSUpdateRequestSerializer implements StructuredSerializer<ModeloClienteGHSUpdateRequest> {
    @override
    final Iterable<Type> types = const [ModeloClienteGHSUpdateRequest, _$ModeloClienteGHSUpdateRequest];

    @override
    final String wireName = r'ModeloClienteGHSUpdateRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, ModeloClienteGHSUpdateRequest object,
    ...
    @override
    ModeloClienteGHSUpdateRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = ModeloClienteGHSUpdateRequestBuilder();
