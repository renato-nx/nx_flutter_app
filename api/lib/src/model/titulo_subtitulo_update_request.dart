...
import 'package:openapi/src/model/linguagem_simple_update_request.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'titulo_subtitulo_update_request.g.dart';

/// TituloSubtituloUpdateRequest
///
/// Properties:
/// * [id] 
/// * [linguagem] 
...
abstract class TituloSubtituloUpdateRequest implements Built<TituloSubtituloUpdateRequest, TituloSubtituloUpdateRequestBuilder> {
    @BuiltValueField(wireName: r'id')
    int? get id;

    @BuiltValueField(wireName: r'linguagem')
    LinguagemSimpleUpdateRequest? get linguagem;
    ...
    @BuiltValueField(wireName: r'recomendacaoPrecausao')
    String? get recomendacaoPrecausao;
    ...
    @BuiltValueField(wireName: r'biodispobilidade')
    String? get biodispobilidade;
    ...
    TituloSubtituloUpdateRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(TituloSubtituloUpdateRequestBuilder b) => b;

    factory TituloSubtituloUpdateRequest([void updates(TituloSubtituloUpdateRequestBuilder b)]) = _$TituloSubtituloUpdateRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<TituloSubtituloUpdateRequest> get serializer => _$TituloSubtituloUpdateRequestSerializer();
}

class _$TituloSubtituloUpdateRequestSerializer implements StructuredSerializer<TituloSubtituloUpdateRequest> {
    @override
    final Iterable<Type> types = const [TituloSubtituloUpdateRequest, _$TituloSubtituloUpdateRequest];

    @override
    final String wireName = r'TituloSubtituloUpdateRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, TituloSubtituloUpdateRequest object,
        ...
        if (object.linguagem != null) {
            result
                ...
                ..add(serializers.serialize(object.linguagem,
                    specifiedType: const FullType(LinguagemSimpleUpdateRequest)));
        }
        ...
        if (object.recomendacaoPrecausao != null) {
            result
                ..add(r'recomendacaoPrecausao')
                ..add(serializers.serialize(object.recomendacaoPrecausao,
                    specifiedType: const FullType(String)));
        }
        ...
        if (object.biodispobilidade != null) {
            result
                ..add(r'biodispobilidade')
                ..add(serializers.serialize(object.biodispobilidade,
                    specifiedType: const FullType(String)));
        }
    ...
    @override
    TituloSubtituloUpdateRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TituloSubtituloUpdateRequestBuilder();
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'linguagem':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(LinguagemSimpleUpdateRequest)) as LinguagemSimpleUpdateRequest;
                ...
                case r'descricaoClassificacaoProduto':
                    ...
                    break;
                case r'recomendacaoPrecausao':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(String)) as String;
                    result.recomendacaoPrecausao = valueDes;
                    break;
                ...
                case r'modoElaboracaoProduto':
                    ...
                    break;
                case r'biodispobilidade':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(String)) as String;
                    result.biodispobilidade = valueDes;
                    break;
