...
part of 'cliente_texto_padrao_linguagem_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ClienteTextoPadraoLinguagemResponse
    extends ClienteTextoPadraoLinguagemResponse {
  @override
  final int? id;
  @override
  ...
  factory _$ClienteTextoPadraoLinguagemResponse(
          [void Function(ClienteTextoPadraoLinguagemResponseBuilder)?
              updates]) =>
      (new ClienteTextoPadraoLinguagemResponseBuilder()..update(updates))
          ._build();

  _$ClienteTextoPadraoLinguagemResponse._(
      {this.id,
      this.cliente,
      this.linguagem,
      this.textoMinisterio,
      this.caracteristicaEmbalagem,
      this.descricaoEnriquecimento,
  ...
  @override
  ClienteTextoPadraoLinguagemResponse rebuild(
          void Function(ClienteTextoPadraoLinguagemResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ClienteTextoPadraoLinguagemResponseBuilder toBuilder() =>
      new ClienteTextoPadraoLinguagemResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ClienteTextoPadraoLinguagemResponse &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ClienteTextoPadraoLinguagemResponse')
          ..add('id', id)
          ..add('cliente', cliente)
...
class ClienteTextoPadraoLinguagemResponseBuilder
    implements
        Builder<ClienteTextoPadraoLinguagemResponse,
            ClienteTextoPadraoLinguagemResponseBuilder> {
  _$ClienteTextoPadraoLinguagemResponse? _$v;
  ...
  ClienteTextoPadraoLinguagemResponseBuilder() {
    ClienteTextoPadraoLinguagemResponse._defaults(this);
  }

  ClienteTextoPadraoLinguagemResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(ClienteTextoPadraoLinguagemResponse other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ClienteTextoPadraoLinguagemResponse;
  }
  ...
  @override
  ClienteTextoPadraoLinguagemResponse build() => _build();

  _$ClienteTextoPadraoLinguagemResponse _build() {
    _$ClienteTextoPadraoLinguagemResponse _$result;
    try {
      _$result = _$v ??
          new _$ClienteTextoPadraoLinguagemResponse._(
              id: id,
              cliente: _cliente?.build(),
              linguagem: _linguagem?.build(),
              textoMinisterio: textoMinisterio,
              caracteristicaEmbalagem: caracteristicaEmbalagem,
              descricaoEnriquecimento: descricaoEnriquecimento,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ClienteTextoPadraoLinguagemResponse',
            _$failedField,
            e.toString());
      }
      rethrow;
