...
part 'tabela_referencia_update_request.g.dart';

/// TabelaReferenciaUpdateRequest
///
/// Properties:
/// * [id] 
/// * [linguagem] 
...
/// * [vitaminaD] 
/// * [vitaminaE] 
abstract class TabelaReferenciaUpdateRequest implements Built<TabelaReferenciaUpdateRequest, TabelaReferenciaUpdateRequestBuilder> {
    ...
    TabelaReferenciaUpdateRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(TabelaReferenciaUpdateRequestBuilder b) => b;

    factory TabelaReferenciaUpdateRequest([void updates(TabelaReferenciaUpdateRequestBuilder b)]) = _$TabelaReferenciaUpdateRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<TabelaReferenciaUpdateRequest> get serializer => _$TabelaReferenciaUpdateRequestSerializer();
}

class _$TabelaReferenciaUpdateRequestSerializer implements StructuredSerializer<TabelaReferenciaUpdateRequest> {
    @override
    final Iterable<Type> types = const [TabelaReferenciaUpdateRequest, _$TabelaReferenciaUpdateRequest];

    @override
    final String wireName = r'TabelaReferenciaUpdateRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, TabelaReferenciaUpdateRequest object,
    ...
    @override
    TabelaReferenciaUpdateRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TabelaReferenciaUpdateRequestBuilder();
