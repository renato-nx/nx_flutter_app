...
abstract class TextoPadrao implements Built<TextoPadrao, TextoPadraoBuilder> {
    ...
    static void _defaults(TextoPadraoBuilder b) => b;

    factory TextoPadrao([void updates(TextoPadraoBuilder b)]) = _$TextoPadrao;

    @BuiltValueSerializer(custom: true)
    static Serializer<TextoPadrao> get serializer => _$TextoPadraoSerializer();
}

class _$TextoPadraoSerializer implements StructuredSerializer<TextoPadrao> {
    @override
    final Iterable<Type> types = const [TextoPadrao, _$TextoPadrao];

    @override
    final String wireName = r'TextoPadrao';

    @override
    Iterable<Object?> serialize(Serializers serializers, TextoPadrao object,
    ...
    @override
    TextoPadrao deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TextoPadraoBuilder();
