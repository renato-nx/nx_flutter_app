...
part 'cabecalho_rtpi_response.g.dart';

/// CabecalhoRTPIResponse
///
/// Properties:
/// * [id] 
/// * [linguagem] 
...
/// * [responsavelTecnico] 
/// * [complemento] 
abstract class CabecalhoRTPIResponse implements Built<CabecalhoRTPIResponse, CabecalhoRTPIResponseBuilder> {
    ...
    CabecalhoRTPIResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(CabecalhoRTPIResponseBuilder b) => b;

    factory CabecalhoRTPIResponse([void updates(CabecalhoRTPIResponseBuilder b)]) = _$CabecalhoRTPIResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<CabecalhoRTPIResponse> get serializer => _$CabecalhoRTPIResponseSerializer();
}

class _$CabecalhoRTPIResponseSerializer implements StructuredSerializer<CabecalhoRTPIResponse> {
    @override
    final Iterable<Type> types = const [CabecalhoRTPIResponse, _$CabecalhoRTPIResponse];

    @override
    final String wireName = r'CabecalhoRTPIResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, CabecalhoRTPIResponse object,
    ...
    @override
    CabecalhoRTPIResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = CabecalhoRTPIResponseBuilder();
