...
part 'cabecalho_rtpi_update_request.g.dart';

/// CabecalhoRTPIUpdateRequest
///
/// Properties:
/// * [id] 
/// * [linguagem] 
...
/// * [responsavelTecnico] 
/// * [complemento] 
abstract class CabecalhoRTPIUpdateRequest implements Built<CabecalhoRTPIUpdateRequest, CabecalhoRTPIUpdateRequestBuilder> {
    ...
    CabecalhoRTPIUpdateRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(CabecalhoRTPIUpdateRequestBuilder b) => b;

    factory CabecalhoRTPIUpdateRequest([void updates(CabecalhoRTPIUpdateRequestBuilder b)]) = _$CabecalhoRTPIUpdateRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<CabecalhoRTPIUpdateRequest> get serializer => _$CabecalhoRTPIUpdateRequestSerializer();
}

class _$CabecalhoRTPIUpdateRequestSerializer implements StructuredSerializer<CabecalhoRTPIUpdateRequest> {
    @override
    final Iterable<Type> types = const [CabecalhoRTPIUpdateRequest, _$CabecalhoRTPIUpdateRequest];

    @override
    final String wireName = r'CabecalhoRTPIUpdateRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, CabecalhoRTPIUpdateRequest object,
    ...
    @override
    CabecalhoRTPIUpdateRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = CabecalhoRTPIUpdateRequestBuilder();
