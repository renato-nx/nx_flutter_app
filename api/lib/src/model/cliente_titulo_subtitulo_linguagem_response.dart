...
part 'cliente_titulo_subtitulo_linguagem_response.g.dart';

/// ClienteTituloSubtituloLinguagemResponse
///
/// Properties:
/// * [id] 
/// * [cliente] 
...
abstract class ClienteTituloSubtituloLinguagemResponse implements Built<ClienteTituloSubtituloLinguagemResponse, ClienteTituloSubtituloLinguagemResponseBuilder> {
    ...
    ClienteTituloSubtituloLinguagemResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(ClienteTituloSubtituloLinguagemResponseBuilder b) => b;

    factory ClienteTituloSubtituloLinguagemResponse([void updates(ClienteTituloSubtituloLinguagemResponseBuilder b)]) = _$ClienteTituloSubtituloLinguagemResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<ClienteTituloSubtituloLinguagemResponse> get serializer => _$ClienteTituloSubtituloLinguagemResponseSerializer();
}

class _$ClienteTituloSubtituloLinguagemResponseSerializer implements StructuredSerializer<ClienteTituloSubtituloLinguagemResponse> {
    @override
    final Iterable<Type> types = const [ClienteTituloSubtituloLinguagemResponse, _$ClienteTituloSubtituloLinguagemResponse];

    @override
    final String wireName = r'ClienteTituloSubtituloLinguagemResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, ClienteTituloSubtituloLinguagemResponse object,
    ...
    @override
    ClienteTituloSubtituloLinguagemResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = ClienteTituloSubtituloLinguagemResponseBuilder();
