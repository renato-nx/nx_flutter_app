...
part of 'modelo_cliente_ghs_update_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ModeloClienteGHSUpdateRequest extends ModeloClienteGHSUpdateRequest {
  @override
  final int id;
  @override
  ...
  factory _$ModeloClienteGHSUpdateRequest(
          [void Function(ModeloClienteGHSUpdateRequestBuilder)? updates]) =>
      (new ModeloClienteGHSUpdateRequestBuilder()..update(updates))._build();

  _$ModeloClienteGHSUpdateRequest._(
      {required this.id,
    ...
    BuiltValueNullFieldError.checkNotNull(
        id, r'ModeloClienteGHSUpdateRequest', 'id');
    BuiltValueNullFieldError.checkNotNull(
        descricao, r'ModeloClienteGHSUpdateRequest', 'descricao');
    BuiltValueNullFieldError.checkNotNull(
        cliente, r'ModeloClienteGHSUpdateRequest', 'cliente');
    BuiltValueNullFieldError.checkNotNull(
        linguagem, r'ModeloClienteGHSUpdateRequest', 'linguagem');
    BuiltValueNullFieldError.checkNotNull(clientePalavraAdvertenciaLinguagem,
        r'ModeloClienteGHSUpdateRequest', 'clientePalavraAdvertenciaLinguagem');
  }

  @override
  ModeloClienteGHSUpdateRequest rebuild(
          void Function(ModeloClienteGHSUpdateRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ModeloClienteGHSUpdateRequestBuilder toBuilder() =>
      new ModeloClienteGHSUpdateRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ModeloClienteGHSUpdateRequest &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ModeloClienteGHSUpdateRequest')
          ..add('id', id)
...
class ModeloClienteGHSUpdateRequestBuilder
    implements
        Builder<ModeloClienteGHSUpdateRequest,
            ModeloClienteGHSUpdateRequestBuilder> {
  _$ModeloClienteGHSUpdateRequest? _$v;
  ...
  ModeloClienteGHSUpdateRequestBuilder() {
    ModeloClienteGHSUpdateRequest._defaults(this);
  }

  ModeloClienteGHSUpdateRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(ModeloClienteGHSUpdateRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ModeloClienteGHSUpdateRequest;
  }

  @override
  void update(void Function(ModeloClienteGHSUpdateRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ModeloClienteGHSUpdateRequest build() => _build();

  _$ModeloClienteGHSUpdateRequest _build() {
    _$ModeloClienteGHSUpdateRequest _$result;
    try {
      _$result = _$v ??
          new _$ModeloClienteGHSUpdateRequest._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ModeloClienteGHSUpdateRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
