...
part of 'importador_create_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ImportadorCreateRequest extends ImportadorCreateRequest {
  @override
  final int? id;
  @override
  ...
  factory _$ImportadorCreateRequest(
          [void Function(ImportadorCreateRequestBuilder)? updates]) =>
      (new ImportadorCreateRequestBuilder()..update(updates))._build();

  _$ImportadorCreateRequest._(
      {this.id,
    ...
    BuiltValueNullFieldError.checkNotNull(
        razaoSocial, r'ImportadorCreateRequest', 'razaoSocial');
    BuiltValueNullFieldError.checkNotNull(
        cliente, r'ImportadorCreateRequest', 'cliente');
  }

  @override
  ImportadorCreateRequest rebuild(
          void Function(ImportadorCreateRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ImportadorCreateRequestBuilder toBuilder() =>
      new ImportadorCreateRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ImportadorCreateRequest &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ImportadorCreateRequest')
          ..add('id', id)
...
class ImportadorCreateRequestBuilder
    implements
        Builder<ImportadorCreateRequest, ImportadorCreateRequestBuilder> {
  _$ImportadorCreateRequest? _$v;
  ...
  ImportadorCreateRequestBuilder() {
    ImportadorCreateRequest._defaults(this);
  }

  ImportadorCreateRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(ImportadorCreateRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ImportadorCreateRequest;
  }

  @override
  void update(void Function(ImportadorCreateRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ImportadorCreateRequest build() => _build();

  _$ImportadorCreateRequest _build() {
    _$ImportadorCreateRequest _$result;
    try {
      _$result = _$v ??
          new _$ImportadorCreateRequest._(
              id: id,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ImportadorCreateRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
