...
part of 'rtpi_create_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RTPICreateRequest extends RTPICreateRequest {
  @override
  final int? id;
  @override
  ...
  factory _$RTPICreateRequest(
          [void Function(RTPICreateRequestBuilder)? updates]) =>
      (new RTPICreateRequestBuilder()..update(updates))._build();

  _$RTPICreateRequest._(
      {this.id,
    ...
    BuiltValueNullFieldError.checkNotNull(
        linguagem, r'RTPICreateRequest', 'linguagem');
    BuiltValueNullFieldError.checkNotNull(
        cliente, r'RTPICreateRequest', 'cliente');
    BuiltValueNullFieldError.checkNotNull(
        layout, r'RTPICreateRequest', 'layout');
    BuiltValueNullFieldError.checkNotNull(
        designacaoProduto, r'RTPICreateRequest', 'designacaoProduto');
    BuiltValueNullFieldError.checkNotNull(clienteLinhaProdutoLinguagem,
        r'RTPICreateRequest', 'clienteLinhaProdutoLinguagem');
    BuiltValueNullFieldError.checkNotNull(clienteClassificacaoProdutoLinguagem,
        r'RTPICreateRequest', 'clienteClassificacaoProdutoLinguagem');
    BuiltValueNullFieldError.checkNotNull(
        revisao, r'RTPICreateRequest', 'revisao');
    BuiltValueNullFieldError.checkNotNull(
        dataUltimaAlteracao, r'RTPICreateRequest', 'dataUltimaAlteracao');
    BuiltValueNullFieldError.checkNotNull(
        dataCadastro, r'RTPICreateRequest', 'dataCadastro');
  }

  @override
  RTPICreateRequest rebuild(void Function(RTPICreateRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RTPICreateRequestBuilder toBuilder() =>
      new RTPICreateRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RTPICreateRequest &&
        id == other.id &&
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, id.hashCode), linguagem.hashCode), cliente.hashCode), layout.hashCode), figura.hashCode), corEtiqueta.hashCode), designacaoProduto.hashCode), clienteLinhaProdutoLinguagem.hashCode), clienteClassificacaoProdutoLinguagem.hashCode),
                                                                                textoMinisterio.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RTPICreateRequest')
          ..add('id', id)
...
class RTPICreateRequestBuilder
    implements Builder<RTPICreateRequest, RTPICreateRequestBuilder> {
  _$RTPICreateRequest? _$v;
  ...
  RTPICreateRequestBuilder() {
    RTPICreateRequest._defaults(this);
  }

  RTPICreateRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(RTPICreateRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$RTPICreateRequest;
  }

  @override
  void update(void Function(RTPICreateRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RTPICreateRequest build() => _build();

  _$RTPICreateRequest _build() {
    _$RTPICreateRequest _$result;
    try {
      _$result = _$v ??
          new _$RTPICreateRequest._(
              id: id,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'RTPICreateRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
