...
part of 'cliente_update_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ClienteUpdateRequest extends ClienteUpdateRequest {
  @override
  final int id;
  @override
  ...
  factory _$ClienteUpdateRequest(
          [void Function(ClienteUpdateRequestBuilder)? updates]) =>
      (new ClienteUpdateRequestBuilder()..update(updates))._build();

  _$ClienteUpdateRequest._(
      {required this.id,
      ...
      this.contratante})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(id, r'ClienteUpdateRequest', 'id');
    BuiltValueNullFieldError.checkNotNull(
        tipoCliente, r'ClienteUpdateRequest', 'tipoCliente');
    BuiltValueNullFieldError.checkNotNull(
        nomeFantasia, r'ClienteUpdateRequest', 'nomeFantasia');
    BuiltValueNullFieldError.checkNotNull(
        razaoSocial, r'ClienteUpdateRequest', 'razaoSocial');
    BuiltValueNullFieldError.checkNotNull(
        cnpj, r'ClienteUpdateRequest', 'cnpj');
    BuiltValueNullFieldError.checkNotNull(
        inscricaoEstadual, r'ClienteUpdateRequest', 'inscricaoEstadual');
    BuiltValueNullFieldError.checkNotNull(
        atividadeEconomica, r'ClienteUpdateRequest', 'atividadeEconomica');
    BuiltValueNullFieldError.checkNotNull(
        codigoSif, r'ClienteUpdateRequest', 'codigoSif');
    BuiltValueNullFieldError.checkNotNull(
        telefone, r'ClienteUpdateRequest', 'telefone');
  }

  @override
  ClienteUpdateRequest rebuild(
          void Function(ClienteUpdateRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ClienteUpdateRequestBuilder toBuilder() =>
      new ClienteUpdateRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ClienteUpdateRequest &&
        id == other.id &&
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, id.hashCode), tipoCliente.hashCode), matrizFilial.hashCode), nomeFantasia.hashCode), razaoSocial.hashCode), cnpj.hashCode), inscricaoEstadual.hashCode), atividadeEconomica.hashCode), codigoSif.hashCode), site.hashCode), email.hashCode),
                                                                                telefone.hashCode),
                                                                            telefone2.hashCode),
                                                                        telefone3.hashCode),
                                                                    endereco.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ClienteUpdateRequest')
          ..add('id', id)
...
class ClienteUpdateRequestBuilder
    implements Builder<ClienteUpdateRequest, ClienteUpdateRequestBuilder> {
  _$ClienteUpdateRequest? _$v;
  ...
  ClienteUpdateRequestBuilder() {
    ClienteUpdateRequest._defaults(this);
  }

  ClienteUpdateRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(ClienteUpdateRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ClienteUpdateRequest;
  }

  @override
  void update(void Function(ClienteUpdateRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ClienteUpdateRequest build() => _build();

  _$ClienteUpdateRequest _build() {
    _$ClienteUpdateRequest _$result;
    try {
      _$result = _$v ??
          new _$ClienteUpdateRequest._(
              id: BuiltValueNullFieldError.checkNotNull(
                  id, r'ClienteUpdateRequest', 'id'),
              ...
              site: site,
              email: email,
              telefone: BuiltValueNullFieldError.checkNotNull(telefone, r'ClienteUpdateRequest', 'telefone'),
              telefone2: telefone2,
              telefone3: telefone3,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ClienteUpdateRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
