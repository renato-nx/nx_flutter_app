...
part of 'cliente_texto_padrao_linguagem_update_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ClienteTextoPadraoLinguagemUpdateRequest
    extends ClienteTextoPadraoLinguagemUpdateRequest {
  @override
  final int? id;
  @override
  ...
  factory _$ClienteTextoPadraoLinguagemUpdateRequest(
          [void Function(ClienteTextoPadraoLinguagemUpdateRequestBuilder)?
              updates]) =>
      (new ClienteTextoPadraoLinguagemUpdateRequestBuilder()..update(updates))
          ._build();

  _$ClienteTextoPadraoLinguagemUpdateRequest._(
      {this.id,
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(textoMinisterio,
        r'ClienteTextoPadraoLinguagemUpdateRequest', 'textoMinisterio');
    BuiltValueNullFieldError.checkNotNull(caracteristicaEmbalagem,
        r'ClienteTextoPadraoLinguagemUpdateRequest', 'caracteristicaEmbalagem');
    BuiltValueNullFieldError.checkNotNull(descricaoEnriquecimento,
        r'ClienteTextoPadraoLinguagemUpdateRequest', 'descricaoEnriquecimento');
    BuiltValueNullFieldError.checkNotNull(
        descricaoControleProdutoAcabado,
        r'ClienteTextoPadraoLinguagemUpdateRequest',
        'descricaoControleProdutoAcabado');
    BuiltValueNullFieldError.checkNotNull(condicoesConservacao,
        r'ClienteTextoPadraoLinguagemUpdateRequest', 'condicoesConservacao');
    BuiltValueNullFieldError.checkNotNull(
        descricaoClassificacaoProduto,
        r'ClienteTextoPadraoLinguagemUpdateRequest',
        'descricaoClassificacaoProduto');
    BuiltValueNullFieldError.checkNotNull(
        textoFinal, r'ClienteTextoPadraoLinguagemUpdateRequest', 'textoFinal');
    BuiltValueNullFieldError.checkNotNull(prazoValidade,
        r'ClienteTextoPadraoLinguagemUpdateRequest', 'prazoValidade');
    BuiltValueNullFieldError.checkNotNull(modoElaboracaoProduto,
        r'ClienteTextoPadraoLinguagemUpdateRequest', 'modoElaboracaoProduto');
  }

  @override
  ClienteTextoPadraoLinguagemUpdateRequest rebuild(
          void Function(ClienteTextoPadraoLinguagemUpdateRequestBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ClienteTextoPadraoLinguagemUpdateRequestBuilder toBuilder() =>
      new ClienteTextoPadraoLinguagemUpdateRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ClienteTextoPadraoLinguagemUpdateRequest &&
        id == other.id &&
  ...
  int get hashCode {
    return $jf($jc(
        ...
        restricoesOutrasRecomendacoes.hashCode));
  }
...
class ClienteTextoPadraoLinguagemUpdateRequestBuilder
    implements
        Builder<ClienteTextoPadraoLinguagemUpdateRequest,
            ClienteTextoPadraoLinguagemUpdateRequestBuilder> {
  _$ClienteTextoPadraoLinguagemUpdateRequest? _$v;
  ...
  ClienteTextoPadraoLinguagemUpdateRequestBuilder() {
    ClienteTextoPadraoLinguagemUpdateRequest._defaults(this);
  }

  ClienteTextoPadraoLinguagemUpdateRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(ClienteTextoPadraoLinguagemUpdateRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ClienteTextoPadraoLinguagemUpdateRequest;
  }

  @override
  void update(
      void Function(ClienteTextoPadraoLinguagemUpdateRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ClienteTextoPadraoLinguagemUpdateRequest build() => _build();

  _$ClienteTextoPadraoLinguagemUpdateRequest _build() {
    final _$result = _$v ??
        new _$ClienteTextoPadraoLinguagemUpdateRequest._(
            id: id,
            textoMinisterio: BuiltValueNullFieldError.checkNotNull(
                textoMinisterio, r'ClienteTextoPadraoLinguagemUpdateRequest', 'textoMinisterio'),
            ...
            condicoesConservacao: BuiltValueNullFieldError.checkNotNull(
                condicoesConservacao, r'ClienteTextoPadraoLinguagemUpdateRequest', 'condicoesConservacao'),
            descricaoClassificacaoProduto: BuiltValueNullFieldError.checkNotNull(descricaoClassificacaoProduto, r'ClienteTextoPadraoLinguagemUpdateRequest', 'descricaoClassificacaoProduto'),
            textoFinal: BuiltValueNullFieldError.checkNotNull(textoFinal, r'ClienteTextoPadraoLinguagemUpdateRequest', 'textoFinal'),
            prazoValidade: BuiltValueNullFieldError.checkNotNull(prazoValidade, r'ClienteTextoPadraoLinguagemUpdateRequest', 'prazoValidade'),
            modoElaboracaoProduto: BuiltValueNullFieldError.checkNotNull(modoElaboracaoProduto, r'ClienteTextoPadraoLinguagemUpdateRequest', 'modoElaboracaoProduto'),
