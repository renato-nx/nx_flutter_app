...
part 'cliente_update_request.g.dart';
...
/// * [fracionador] 
/// * [contratante] 
abstract class ClienteUpdateRequest implements Built<ClienteUpdateRequest, ClienteUpdateRequestBuilder> {
    ...
    ClienteUpdateRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(ClienteUpdateRequestBuilder b) => b;

    factory ClienteUpdateRequest([void updates(ClienteUpdateRequestBuilder b)]) = _$ClienteUpdateRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<ClienteUpdateRequest> get serializer => _$ClienteUpdateRequestSerializer();
}

class _$ClienteUpdateRequestSerializer implements StructuredSerializer<ClienteUpdateRequest> {
    @override
    final Iterable<Type> types = const [ClienteUpdateRequest, _$ClienteUpdateRequest];

    @override
    final String wireName = r'ClienteUpdateRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, ClienteUpdateRequest object,
    ...
    @override
    ClienteUpdateRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = ClienteUpdateRequestBuilder();
