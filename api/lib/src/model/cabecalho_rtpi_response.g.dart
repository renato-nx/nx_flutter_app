...
part of 'cabecalho_rtpi_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CabecalhoRTPIResponse extends CabecalhoRTPIResponse {
  @override
  final int? id;
  @override
  ...
  factory _$CabecalhoRTPIResponse(
          [void Function(CabecalhoRTPIResponseBuilder)? updates]) =>
      (new CabecalhoRTPIResponseBuilder()..update(updates))._build();

  _$CabecalhoRTPIResponse._(
      {this.id,
      this.linguagem,
      this.produto,
      this.revisao,
  ...
  @override
  CabecalhoRTPIResponse rebuild(
          void Function(CabecalhoRTPIResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CabecalhoRTPIResponseBuilder toBuilder() =>
      new CabecalhoRTPIResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CabecalhoRTPIResponse &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CabecalhoRTPIResponse')
          ..add('id', id)
...
class CabecalhoRTPIResponseBuilder
    implements Builder<CabecalhoRTPIResponse, CabecalhoRTPIResponseBuilder> {
  _$CabecalhoRTPIResponse? _$v;
  ...
  CabecalhoRTPIResponseBuilder() {
    CabecalhoRTPIResponse._defaults(this);
  }

  CabecalhoRTPIResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(CabecalhoRTPIResponse other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$CabecalhoRTPIResponse;
  }

  @override
  void update(void Function(CabecalhoRTPIResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  CabecalhoRTPIResponse build() => _build();

  _$CabecalhoRTPIResponse _build() {
    _$CabecalhoRTPIResponse _$result;
    try {
      _$result = _$v ??
          new _$CabecalhoRTPIResponse._(
              id: id,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'CabecalhoRTPIResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
