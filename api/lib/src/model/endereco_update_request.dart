...
part 'endereco_update_request.g.dart';
...
/// * [cep] 
/// * [cidade] 
abstract class EnderecoUpdateRequest implements Built<EnderecoUpdateRequest, EnderecoUpdateRequestBuilder> {
    ...
    EnderecoUpdateRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(EnderecoUpdateRequestBuilder b) => b;

    factory EnderecoUpdateRequest([void updates(EnderecoUpdateRequestBuilder b)]) = _$EnderecoUpdateRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<EnderecoUpdateRequest> get serializer => _$EnderecoUpdateRequestSerializer();
}

class _$EnderecoUpdateRequestSerializer implements StructuredSerializer<EnderecoUpdateRequest> {
    @override
    final Iterable<Type> types = const [EnderecoUpdateRequest, _$EnderecoUpdateRequest];

    @override
    final String wireName = r'EnderecoUpdateRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, EnderecoUpdateRequest object,
    ...
    @override
    EnderecoUpdateRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = EnderecoUpdateRequestBuilder();
