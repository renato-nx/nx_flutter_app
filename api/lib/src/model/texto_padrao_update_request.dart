...
part 'texto_padrao_update_request.g.dart';

/// TextoPadraoUpdateRequest
///
/// Properties:
/// * [id] 
/// * [linguagem] 
...
abstract class TextoPadraoUpdateRequest implements Built<TextoPadraoUpdateRequest, TextoPadraoUpdateRequestBuilder> {
    ...
    TextoPadraoUpdateRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(TextoPadraoUpdateRequestBuilder b) => b;

    factory TextoPadraoUpdateRequest([void updates(TextoPadraoUpdateRequestBuilder b)]) = _$TextoPadraoUpdateRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<TextoPadraoUpdateRequest> get serializer => _$TextoPadraoUpdateRequestSerializer();
}

class _$TextoPadraoUpdateRequestSerializer implements StructuredSerializer<TextoPadraoUpdateRequest> {
    @override
    final Iterable<Type> types = const [TextoPadraoUpdateRequest, _$TextoPadraoUpdateRequest];

    @override
    final String wireName = r'TextoPadraoUpdateRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, TextoPadraoUpdateRequest object,
    ...
    @override
    TextoPadraoUpdateRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TextoPadraoUpdateRequestBuilder();
