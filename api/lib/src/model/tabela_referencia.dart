...
/// * [vitaminaD] 
/// * [vitaminaE] 
abstract class TabelaReferencia implements Built<TabelaReferencia, TabelaReferenciaBuilder> {
    ...
    static void _defaults(TabelaReferenciaBuilder b) => b;

    factory TabelaReferencia([void updates(TabelaReferenciaBuilder b)]) = _$TabelaReferencia;

    @BuiltValueSerializer(custom: true)
    static Serializer<TabelaReferencia> get serializer => _$TabelaReferenciaSerializer();
}

class _$TabelaReferenciaSerializer implements StructuredSerializer<TabelaReferencia> {
    @override
    final Iterable<Type> types = const [TabelaReferencia, _$TabelaReferencia];

    @override
    final String wireName = r'TabelaReferencia';

    @override
    Iterable<Object?> serialize(Serializers serializers, TabelaReferencia object,
    ...
    @override
    TabelaReferencia deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = TabelaReferenciaBuilder();
