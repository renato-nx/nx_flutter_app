...
part 'layout_create_request.g.dart';
...
/// * [resolucao] 
/// * [cliente] 
abstract class LayoutCreateRequest implements Built<LayoutCreateRequest, LayoutCreateRequestBuilder> {
    ...
    LayoutCreateRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(LayoutCreateRequestBuilder b) => b;

    factory LayoutCreateRequest([void updates(LayoutCreateRequestBuilder b)]) = _$LayoutCreateRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<LayoutCreateRequest> get serializer => _$LayoutCreateRequestSerializer();
}

class _$LayoutCreateRequestSerializer implements StructuredSerializer<LayoutCreateRequest> {
    @override
    final Iterable<Type> types = const [LayoutCreateRequest, _$LayoutCreateRequest];

    @override
    final String wireName = r'LayoutCreateRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, LayoutCreateRequest object,
    ...
    @override
    LayoutCreateRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = LayoutCreateRequestBuilder();
