...
part 'importador_update_request.g.dart';

/// ImportadorUpdateRequest
///
/// Properties:
/// * [id] 
/// * [razaoSocial] 
...
/// * [ativo] 
/// * [cliente] 
abstract class ImportadorUpdateRequest implements Built<ImportadorUpdateRequest, ImportadorUpdateRequestBuilder> {
    ...
    ImportadorUpdateRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(ImportadorUpdateRequestBuilder b) => b;

    factory ImportadorUpdateRequest([void updates(ImportadorUpdateRequestBuilder b)]) = _$ImportadorUpdateRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<ImportadorUpdateRequest> get serializer => _$ImportadorUpdateRequestSerializer();
}

class _$ImportadorUpdateRequestSerializer implements StructuredSerializer<ImportadorUpdateRequest> {
    @override
    final Iterable<Type> types = const [ImportadorUpdateRequest, _$ImportadorUpdateRequest];

    @override
    final String wireName = r'ImportadorUpdateRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, ImportadorUpdateRequest object,
    ...
    @override
    ImportadorUpdateRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = ImportadorUpdateRequestBuilder();
