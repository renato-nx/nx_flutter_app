...
import 'package:openapi/src/model/rtpi_enriquecimento_create_request.dart';
import 'package:openapi/src/model/id_simple_create_request.dart';
import 'package:built_collection/built_collection.dart';
import 'package:openapi/src/model/rtpi_substitutivo_update_request.dart';
import 'package:openapi/src/model/rtpi_composicao_qualitativa_create_request.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'rtpi_update_request.g.dart';
...
/// * [enriquecimentos] 
/// * [substitutivos] 
abstract class RTPIUpdateRequest implements Built<RTPIUpdateRequest, RTPIUpdateRequestBuilder> {
    ...
    @BuiltValueField(wireName: r'enriquecimentos')
    BuiltList<RTPIEnriquecimentoCreateRequest>? get enriquecimentos;

    @BuiltValueField(wireName: r'substitutivos')
    BuiltList<RTPISubstitutivoUpdateRequest>? get substitutivos;

    RTPIUpdateRequest._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(RTPIUpdateRequestBuilder b) => b;

    factory RTPIUpdateRequest([void updates(RTPIUpdateRequestBuilder b)]) = _$RTPIUpdateRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<RTPIUpdateRequest> get serializer => _$RTPIUpdateRequestSerializer();
}

class _$RTPIUpdateRequestSerializer implements StructuredSerializer<RTPIUpdateRequest> {
    @override
    final Iterable<Type> types = const [RTPIUpdateRequest, _$RTPIUpdateRequest];

    @override
    final String wireName = r'RTPIUpdateRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, RTPIUpdateRequest object,
        ...
        if (object.enriquecimentos != null) {
            result
                ..add(r'enriquecimentos')
                ..add(serializers.serialize(object.enriquecimentos,
                    specifiedType: const FullType(BuiltList, [FullType(RTPIEnriquecimentoCreateRequest)])));
        }
        if (object.substitutivos != null) {
            result
                ..add(r'substitutivos')
                ..add(serializers.serialize(object.substitutivos,
                    specifiedType: const FullType(BuiltList, [FullType(RTPISubstitutivoUpdateRequest)])));
        }
        return result;
    }

    @override
    RTPIUpdateRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = RTPIUpdateRequestBuilder();
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'composicoes':
                    ...
                    break;
                case r'enriquecimentos':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(RTPIEnriquecimentoCreateRequest)])) as BuiltList<RTPIEnriquecimentoCreateRequest>;
                    result.enriquecimentos.replace(valueDes);
                    break;
                case r'substitutivos':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(RTPISubstitutivoUpdateRequest)])) as BuiltList<RTPISubstitutivoUpdateRequest>;
