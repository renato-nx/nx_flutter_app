...
part of 'solicitante_update_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$SolicitanteUpdateRequest extends SolicitanteUpdateRequest {
  @override
  final int id;
  @override
  ...
  factory _$SolicitanteUpdateRequest(
          [void Function(SolicitanteUpdateRequestBuilder)? updates]) =>
      (new SolicitanteUpdateRequestBuilder()..update(updates))._build();

  _$SolicitanteUpdateRequest._(
      {required this.id,
      this.razaoSocial,
      this.registro,
      this.endereco,
    ...
    BuiltValueNullFieldError.checkNotNull(
        id, r'SolicitanteUpdateRequest', 'id');
    BuiltValueNullFieldError.checkNotNull(
        cliente, r'SolicitanteUpdateRequest', 'cliente');
  }

  @override
  SolicitanteUpdateRequest rebuild(
          void Function(SolicitanteUpdateRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SolicitanteUpdateRequestBuilder toBuilder() =>
      new SolicitanteUpdateRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SolicitanteUpdateRequest &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SolicitanteUpdateRequest')
          ..add('id', id)
...
class SolicitanteUpdateRequestBuilder
    implements
        Builder<SolicitanteUpdateRequest, SolicitanteUpdateRequestBuilder> {
  _$SolicitanteUpdateRequest? _$v;
  ...
  SolicitanteUpdateRequestBuilder() {
    SolicitanteUpdateRequest._defaults(this);
  }

  SolicitanteUpdateRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(SolicitanteUpdateRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SolicitanteUpdateRequest;
  }

  @override
  void update(void Function(SolicitanteUpdateRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SolicitanteUpdateRequest build() => _build();

  _$SolicitanteUpdateRequest _build() {
    _$SolicitanteUpdateRequest _$result;
    try {
      _$result = _$v ??
          new _$SolicitanteUpdateRequest._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SolicitanteUpdateRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
