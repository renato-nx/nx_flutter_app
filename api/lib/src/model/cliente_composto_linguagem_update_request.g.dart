...
part of 'cliente_composto_linguagem_update_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ClienteCompostoLinguagemUpdateRequest
    extends ClienteCompostoLinguagemUpdateRequest {
  @override
  final int id;
  @override
  final String nome;
  ...
  factory _$ClienteCompostoLinguagemUpdateRequest(
          [void Function(ClienteCompostoLinguagemUpdateRequestBuilder)?
              updates]) =>
      (new ClienteCompostoLinguagemUpdateRequestBuilder()..update(updates))
          ._build();

  _$ClienteCompostoLinguagemUpdateRequest._(
      {required this.id,
      required this.nome,
    ...
    BuiltValueNullFieldError.checkNotNull(
        id, r'ClienteCompostoLinguagemUpdateRequest', 'id');
    BuiltValueNullFieldError.checkNotNull(
        nome, r'ClienteCompostoLinguagemUpdateRequest', 'nome');
    BuiltValueNullFieldError.checkNotNull(ordemComposicaoQualitativa,
        r'ClienteCompostoLinguagemUpdateRequest', 'ordemComposicaoQualitativa');
    BuiltValueNullFieldError.checkNotNull(ordemNiveisGarantia,
        r'ClienteCompostoLinguagemUpdateRequest', 'ordemNiveisGarantia');
  }

  @override
  ClienteCompostoLinguagemUpdateRequest rebuild(
          void Function(ClienteCompostoLinguagemUpdateRequestBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ClienteCompostoLinguagemUpdateRequestBuilder toBuilder() =>
      new ClienteCompostoLinguagemUpdateRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ClienteCompostoLinguagemUpdateRequest &&
        id == other.id &&
        nome == other.nome &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'ClienteCompostoLinguagemUpdateRequest')
          ..add('id', id)
          ..add('nome', nome)
...
class ClienteCompostoLinguagemUpdateRequestBuilder
    implements
        Builder<ClienteCompostoLinguagemUpdateRequest,
            ClienteCompostoLinguagemUpdateRequestBuilder> {
  _$ClienteCompostoLinguagemUpdateRequest? _$v;
  ...
  ClienteCompostoLinguagemUpdateRequestBuilder() {
    ClienteCompostoLinguagemUpdateRequest._defaults(this);
  }

  ClienteCompostoLinguagemUpdateRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _nome = $v.nome;
  ...
  @override
  void replace(ClienteCompostoLinguagemUpdateRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ClienteCompostoLinguagemUpdateRequest;
  }

  @override
  void update(
      void Function(ClienteCompostoLinguagemUpdateRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ClienteCompostoLinguagemUpdateRequest build() => _build();

  _$ClienteCompostoLinguagemUpdateRequest _build() {
    _$ClienteCompostoLinguagemUpdateRequest _$result;
    try {
      _$result = _$v ??
          new _$ClienteCompostoLinguagemUpdateRequest._(
